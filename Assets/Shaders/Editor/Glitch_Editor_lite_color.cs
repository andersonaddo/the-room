...
public class Glitch_Editor_lite_color : ShaderGUI
{
	...
	// GUI FUNCTION	
        ...
        MaterialProperty _DeformColor = FindProperty("_GlitchColor", properties);
        editor.ShaderProperty(_DeformColor, "Deformation Color");
